...
func (e *ActiveEventsRepository) GetByCentralID(db *sql.DB, centralID string) ([]ActiveEvents, []int, error) {
	rows, err := db.Query(`SELECT uuid, event_number, event_date, central_id, priority, title, 
